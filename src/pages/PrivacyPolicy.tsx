          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-3 text-sm md:text-base leading-relaxed opacity-70">
                ...
                <p><strong className="text-[#f0f0e8]">&ndash; Identity Data</strong> includes your email address and authentication identifiers. If you sign in with Google, Facebook, or Apple, we receive only basic profile information (such as your name and email) from those providers&mdash;never your passwords.</p>
                <p><strong className="text-[#f0f0e8]">&ndash; Contact Data</strong> includes the email address you use to create your account or sign in via social providers.</p>
                <p><strong className="text-[#f0f0e8]">&ndash; Technical Data</strong> includes your device type, operating system version, app version, and crash/error reports if you opt in. This helps us diagnose issues and improve app stability.</p>
                ...
                <p><strong className="text-[#f0f0e8]">&ndash; Subscription Data</strong> includes your subscription status (active, expired, or cancelled), subscription tier, and anonymous transaction identifiers. This data is managed by RevenueCat, our subscription management provider. We never receive or store your payment card details&mdash;all payment processing is handled securely by Apple&apos;s App Store.</p>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm md:text-base leading-relaxed opacity-70">
                ...
                <p><strong className="text-[#f0f0e8]">Premium subscribers are never shown ads</strong> and no advertising-related data is collected for premium users.</p>
              ...
              <div className="space-y-6 text-sm md:text-base leading-relaxed opacity-70">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong className="text-[#f0f0e8]">How it works:</strong> When you sign up for WipeSwipe using email, Google, Facebook, or Apple Sign-In, our authentication provider (Clerk) collects and stores your email address to create and manage your account. Your authentication tokens are stored securely on your device.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong className="text-[#f0f0e8]">How it works:</strong> WipeSwipe accesses your device&apos;s photo library with your explicit permission to display photos for sorting. Your photos never leave your device&mdash;all processing happens locally. Your sorting decisions (kept/discarded photo IDs), preferences (haptics, sort order), and progress are stored exclusively on your device using secure local storage.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong className="text-[#f0f0e8]">How it works:</strong> We may collect anonymized, aggregated data about app usage patterns&mdash;such as which features are used most frequently or common error states&mdash;to help us improve WipeSwipe. This data cannot be used to identify you personally.</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-3 text-sm md:text-base leading-relaxed opacity-70">
                ...
                <p><strong className="text-[#f0f0e8]">2. Subscription management provider</strong> &mdash; We use RevenueCat to manage subscriptions and in-app purchases. RevenueCat receives anonymized purchase data from Apple&apos;s App Store to sync your subscription status across devices. RevenueCat does not receive your payment card details. RevenueCat&apos;s data handling is governed by their privacy policy.</p>
                ...
                <p><strong className="text-[#f0f0e8]">5. Advertising provider (free users only)</strong> &mdash; We use Google AdMob to display native ads to free users. AdMob may collect device advertising identifiers and ad interaction data to serve relevant ads and measure ad performance. AdMob&apos;s data practices are governed by Google&apos;s privacy policy. Premium subscribers are never shown ads and no advertising data is shared with AdMob for these users.</p>
                <p><strong className="text-[#f0f0e8]">6. Anonymous analytics providers</strong> &mdash; We may use analytics tools to collect anonymized usage data (such as app feature usage, crash reports, and performance metrics) to improve WipeSwipe. This data cannot identify you personally and never includes your photos, photo decisions, or account credentials.</p>
